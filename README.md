...
The buffer module from [node.js](https://nodejs.org/).
...
## license
MIT License
Copyright (c) 2023 [drkaz.dev](https://drkaz.dev) based on work of [Feross Aboukhadijeh](http://feross.org), and other contributors. Originally forked from an MIT-licensed module by Romain Beauxis.